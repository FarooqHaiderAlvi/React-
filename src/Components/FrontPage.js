    ...
    <div className='container-fluid back' style={{fontFamily: "MyCustomFont" }}>
      ...
      <div className="container my-4 py-1 ">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-5 ">
            ...
            <img className='mr-3' src={im2} alt="" style={{
              height: 40, width: 40
            }} />
      ...
      <div className="container py-4">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-6 d-flex justify-content-center">
            <img src={im4} className="img-fluid" alt="" style={{
      ...
      <div className="container py-4">
        <div className="row">
          ...
          <div className="col-md-6 d-flex justify-content-center">
            <img src={im7} className="img-fluid img-rounded oval" alt="" />
          </div>
          <div className="col-md-6">
            <h2>COMPETENT COUNSELLOR</h2>
      ...
      <div className="container py-4">
        <div className="row">
          ...
          <div className="col-md-6 d-flex justify-content-center">
            <img src={im6} className="img-fluid img-rounded" alt="" />
          </div>
          <div className="col-md-6">
            <h2>VIDEO LECTURES</h2>
            <h2>AND NOTES</h2>
            <p>
              Our notes are meticulously crafted to provide concise summaries
              of each topic covered in cur video lectures. They are designed to
              help you review and retain the information covered in class,
              making it easier for you to prepare for exams and complete assignments.
              We believe that our video lectures and notes can make a real difference in
              your academic performance, and we are committed to helping you cchieve your goals.
              So, whether you are looking to improve your grades or expand your knowledge
              , we are here to help you every step of the wa
            </p>
          </div>
